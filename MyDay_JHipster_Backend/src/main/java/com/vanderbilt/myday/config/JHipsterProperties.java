package com.vanderbilt.myday.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "MyDay@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "MyDay API";

        private String description = "MyDay API documentation";
